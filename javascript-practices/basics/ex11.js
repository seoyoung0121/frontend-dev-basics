...
var sum = function (a, b) {
  ...
  // argument의 prototype은 object.prototype을 상속하기에 안됨,,
...
// apply: 호출되는 함수의 this를 파라미터로 전달되는 객체로 바꿔서 즉시 호출한다.
var yourObject = {
  v: "you",
};
myObject.f1.apply(yourObject);

// call: 호출되는 함수의 this를 첫번째 파라미터로 전달되는 객체로 바꿔서 즉시 그 함수를 호출한다. (그 함수의 파라미터와 함께 전달)
